...
class PermutationCDPMutation(Mutation[PermutationSolution]):
    def execute(self, problem_CDP: Problem, solution: PermutationSolution) -> PermutationSolution:
        Check.that(type(solution) is PermutationSolution, "Solution type invalid" )
        # here change to random    
        new_solution = problem_CDP.mutate(self.probability,solution)
        return new_solution


    def get_name(self):
        return "Permutation CDP mutation"
